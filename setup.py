...
setup(
  name = 'invoice-generator-excel-to-pdf',         #* Your package will have this name
  packages = ['pdf_invoice_generator'],   #* Name the package again
  ...
  author = 'Mahmudur Mahid',                   # Your name
  author_email = 'm.mahid@icloud.com',  # Your email
  url = 'https://github.com/mahmudurmahid',              # Homepage of your library (e.g. github or your website)
